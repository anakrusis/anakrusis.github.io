ENTRIES = {
	...
	"tile.cactus.name":{
        ...
        "notes": "Cacti are native to the Americas-- with possibly one exception. <i>Rhipsalis baccifera</i> is native to a large part of Africa as far north as Sudan <a href=\"https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:219250-2\">(source: Kew)</a>. But there is still uncertainty over how and when this cactus ended up in Africa. If it happened during the period of early modern trade with the Americas, then a Coptic word for cactus is unlikely to have existed. But if <i>R. baccifera</i> has been there since antiquity or earlier, then it is possible a Coptic word exists for it. Here are some possibilities:<br><br>[k]<b>• ⲁⲗ: </b>[/k]This word is in Mawood's dictionary as \"<i>cactus</i> الصبَّارة\" [c]Mawood-2[/c] and it is both Sahidic and Bohairic. But I do not know of any texts where it is attested in (if anyone knows where, I would greatly appreciate it).<br>I thought about the possibility of this word being related to [k]ⲁⲗⲗⲱⲏ[/k] \"aloe\", especially considering the same semantic shift happened in Arabic with صبار <i>ṣabbār</i> \"cactus\" derived from صبر <i>ṣabr</i> \"aloe\".<br><br>[k]<b>• ⲕⲁⲕⲧⲟⲥ: </b>[/k]Following the example of many modern languages that repurposed the old Greek word κάκτος (which did not originally refer to cactus). Compare Armenian կակտուս <i>kaktus</i>, Hebrew קקטוס <i>kaktus</i>, Latin <i>cactus</i>, Persian کاکتوس <i>kâktus</i>, etc.<br><br>It should also be noted that many other kinds of succulent plants can be found in the region, and the one true cactus which may be native does not really resemble the Minecraft cactus. So an exact match is probably not going to happen, and it's okay to be flexible when choosing a word for it. ",
