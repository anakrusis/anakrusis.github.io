...
/* 	"itemGroup.misc": {
	...
	"color.lightBlue": {
		...
		"english": "Light Blue",
		"etym": [ "< Egyptian[h]𓇋𓁻𓈖𓐛𓁸𓏌𓇯𓆰𓏥[/h]<i>jwn-n-p.t</i> \"color of heaven (a plant)\", which is: <table><tr><td style=\"width:50%\"></td><td></td></tr></table>" ],
		"notes": "The research on this word is thanks to ℝandy 𓉑. After hours of research they tracked down the original attestations and posted their findings in [k]ⲧⲁⲛⲥⲏⲃⲉ ⲛⲧⲙⲛⲧⲣⲙⲛⲕⲏⲙⲉ[/k]. Although I was previously aware of the word and added it to the resource pack back in November 2023, ℝandy 𓉑's research was what resolved a lot of the uncertainty I had, so I am very thankful for their hard work.<br><br>The sources I had seen previously were giving me mixed signals, because [k]<b>ⲁⲩⲁⲛ ⲙ̄ⲡⲉ</b>[/k] seems to either refer to the color, and/or a specific type of linen: \"sky-colored, blue\" [c]cd|20b, 259a[/c], \"	linen (\'colour of the sky\')\" [c]cdo|C243[/c] \"sky-blue\" [c]lambdin|256[/c], \"material from which clothes are made = linen\" [c]vy|19[/c]. Vycichl explains that this is in reference to the blue flowers of certain species of flax. Although flax is usually called <i>mḥꜥ</i> (> [k]ⲙⲁϩⲉ[/k]), this is essentially a poetic name for it.",
